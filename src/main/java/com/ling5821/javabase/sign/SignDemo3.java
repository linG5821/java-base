...
public class SignDemo3 {
    ...
    public static void main(String[] args) {
        ...
        HttpPost request = new HttpPost(
            "https://openapi-test.alpha.milvzn.com/api/v1/review/file_url_pattern");
        RequestBody body = new RequestBody("xxx.docx",
            "xxx",
            "xxx");
        ...
        try {
            String contentMd5 = buildContentMd5(jsonStr.getBytes(StandardCharsets.UTF_8));
            request.addHeader(HTTPHeaderContentType, "application/json;charset=UTF-8");
